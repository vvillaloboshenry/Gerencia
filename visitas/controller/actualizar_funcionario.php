...
echo $_POST["m_idFuncionario"] . ' ' . $_POST["m_dniFuncionario"] . ' ' . $_POST["m_nombreFuncionario"] . ' ' . $_POST["m_apellidoPaternoFuncionario"] . ' ' . $_POST["m_apellidoMaternoFuncionario"] . ' ' . $_POST["m_emailFuncionario"] . ' ' . $_POST["m_cargoFuncionario"] . ' ' . $_POST["m_idUnidadOrganica"];
